...
import {create, getName} from './api-product.js'
...
const name = {
  ...
  const category = {
    default:'Gents',
    enum:['Gents','Ladies','Gents Wedding','Ladies Wedding','Kids']
  }
  ...
  useEffect(() => {
    ...
    getName(signal).then((data) => {
      if (data.error) {
        setNames({...names, error: "Could not get name"})
      } else {
        setNames({...names, name: data, error: ''})
      }
    })
      ...
      <Card className={classes.card}>
        <CardContent>
          ...
          <TextField
              ...
              margin="normal"
            >
            <MenuItem value={'Shalwaar Qameez'}>Shalwaar Qameez</MenuItem>
            <MenuItem value={'Shirwaani'}>Shirwaani</MenuItem>
            <MenuItem value={'Lehnga'}>Lehnga</MenuItem>
            <MenuItem value={'Saarree'}>Saarree</MenuItem>
            <MenuItem value={'Men Kurta'}>Men Kurta</MenuItem>
            <MenuItem value={'Ladies Shalwaar Qameez'}>Ladies Shalwaar Qameez</MenuItem>
            </TextField>
          <TextField
          ...
          <MenuItem value={'Gents Wedding'}>Gents Wedding</MenuItem>
          <MenuItem value={'Ladies Wedding'}>Ladies Wedding</MenuItem>
          <MenuItem value={'Kids'}>Kids</MenuItem>
          
            
          </TextField>
          <TextField id="quantity" label="Capacity" className={classes.textField} value={values.quantity} onChange={handleChange('quantity')} type="number" margin="normal"/><br/>
