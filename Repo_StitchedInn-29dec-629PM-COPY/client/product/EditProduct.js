...
export default function EditProduct ({match}) {
  ...
  const clickSubmit = () => {
    ...
    values.quantity && productData.append('capacity', values.quantity)
    ...
    return (<div>
      <Card className={classes.card}>
        <CardContent>
          ...
          <TextField id="capacity" label="Capacity" className={classes.textField} value={values.quantity} onChange={handleChange('quantity')} type="number" margin="normal"/><br/>
