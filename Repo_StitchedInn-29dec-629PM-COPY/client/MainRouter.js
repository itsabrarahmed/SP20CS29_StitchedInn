...
import SignupClient from './user/Signup-Client'
...
import AllTailors from './dashboard/AllTailors'
import AllCustomers from './dashboard/AllCustomers'
//import Home2 from './views/LandingPage/LandingPage'
...
const MainRouter = () => {
  return (<div>
      ...
      <Switch>
        ...
        <Route path="/allTailors" component={AllTailors}/>
