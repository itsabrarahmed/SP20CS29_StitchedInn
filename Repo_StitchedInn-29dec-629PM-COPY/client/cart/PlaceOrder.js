...
const PlaceOrder = (props) => {
  ...
  const placeOrder = ()=>{
    ...
    // t: jwt.token
    // }, props.checkoutDetails, undefined).then((data) => {

    // const order = {
    //   products: props.checkoutDetails.products || undefined,
    //   customer_name: props.checkoutDetails.customer_name || undefined,
    //   customer_email: props.checkoutDetails.customer_email || undefined,
    //   delivery_address: props.checkoutDetails.delivery_address || undefined,
    //   payment_id: undefined
    // }
    // create(order).then((data) => {
    //   if (data.error) {
  ...
  // })
        ...
        create({userId:jwt.user._id}, {
          t: jwt.token
        }, props.checkoutDetails, 1).then((data) => {
