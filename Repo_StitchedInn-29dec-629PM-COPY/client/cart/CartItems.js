...
export default function CartItems (props) {
  ...
  const openCheckout = () => {
    ...
    console.log('in cart items folder')
    ...
    return (<Card className={classes.card}>
            ...
            return <span key={i}><Card className={classes.cart}>
              ...
              <div className={classes.details}>
                <CardContent className={classes.content}>
                  ...
                  <div>
                    <Typography type="subheading" component="h3" className={classes.price} color="primary">PKR {item.product.price}</Typography>
      ...
      <Typography variant="subtitle1" component="h3" color="primary">No More Orders Added.</Typography>
    }
    </Card>)
}
