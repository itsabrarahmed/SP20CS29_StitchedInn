...
router.route('/api/orders/shop/:shopId')
  ...
  //.get(orderCtrl.listByShop)

router.route('/api/orders/user/:userId')
  .get(authCtrl.requireSignin, orderCtrl.listByUser)
  //.get(orderCtrl.listByUser)

router.route('/api/order/status_values')
  .get(orderCtrl.getStatusValues)

router.route('/api/order/fabric_status_values')
  .get(orderCtrl.getFabricStatusValues)  

router.route('/api/order/rating')
  .get(orderCtrl.getRating)    

router.route('/api/order/today')
  .get(orderCtrl.todayOrders)   
...
router.route('/api/order/fabricstatus/:shopId')
  .put(authCtrl.requireSignin, shopCtrl.isOwner, orderCtrl.updateFabricStatus)

router.route('/api/order/updaterating/:shopId')
  .put(authCtrl.requireSignin, orderCtrl.updateRating)  
